...
<body class="bg-dark">
	<div class="text-center border border-dark">
		<div class="main">
		<img src="Milk.jpg" alt="Milk" style="width: 100px; height: auto;">
		...
		<div class="fixed-bottom mb-2">
			...
			<div class="d-inline">
				<button type="button" id="user" class="btn-lg btn-secondary" data-toggle="modal" data-target="#modal-user"><i class="fas fa-user"></i> POS</button>
			</div>
		</div>
	</div>
