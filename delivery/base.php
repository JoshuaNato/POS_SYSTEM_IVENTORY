<div class="header bg-dark">
	<img class="img-fluid w-100 mt-2 ml-1" src="../images/milk.jpg" >
</div>
<div class="sidebar">
	...
	<button id="sidebar_button" onclick="window.location.href='../delivery/add_delivery.php'"><i class="fas fa-truck"></i>Records</button>
	...
	<button id="sidebar_button" data-toggle="popover" title="Records" data-content="After the textbox is filled, Please click the Buy Price Textbox and Tax Rate(%) Textbox to get the Sell Price Value. " data-placement="bottom"><i class="fas fa-question"></i> Help</button>
