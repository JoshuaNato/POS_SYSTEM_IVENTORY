...
<body>
	<div class="h-100 bg-dark" id="container">
		<div id="header">
			...
			<div>
			<img class="img-fluid m-2" src="images/milk.jpg" style="width: 150px; height: auto;">
		...
		<div id="footer" class="w-100">
			...
			<button id="buttons" onclick="window.location.href='user/orders.php'" class="btn btn-secondary border mr-2 ml-2"><i class="fas fa-users"></i> POS</button>
			...
			<button id="buttons" onclick="window.location.href='delivery/delivery.php'" class="btn btn-secondary border mr-2"><i class="fas fa-truck"></i> Records</button>
